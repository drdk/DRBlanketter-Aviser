...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44736492878877172)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44736749101877175)
,p_plug_template_id=>wwv_flow_api.id(44736492878877172)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44737004360877176)
,p_plug_template_id=>wwv_flow_api.id(44736492878877172)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44737395037877176)
,p_plug_template_id=>wwv_flow_api.id(44736492878877172)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44737665124877176)
,p_plug_template_id=>wwv_flow_api.id(44736492878877172)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44737913456877176)
,p_plug_template_id=>wwv_flow_api.id(44736492878877172)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44738222233877176)
,p_plug_template_id=>wwv_flow_api.id(44736492878877172)
,p_name=>'Sub Regions'
