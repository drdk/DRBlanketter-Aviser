...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44748788481877182)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44749068261877182)
,p_plug_template_id=>wwv_flow_api.id(44748788481877182)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44749379477877183)
,p_plug_template_id=>wwv_flow_api.id(44748788481877182)
,p_name=>'Sub Regions'
