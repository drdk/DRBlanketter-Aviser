...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44750332354877183)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44750611064877183)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44750981347877183)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44751242035877184)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44751536961877184)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44751871821877184)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44752101815877184)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44752456690877184)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44752792327877184)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44753034402877184)
,p_plug_template_id=>wwv_flow_api.id(44750332354877183)
,p_name=>'Sub Regions'
