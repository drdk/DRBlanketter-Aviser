...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44760409832877189)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44760767578877189)
,p_plug_template_id=>wwv_flow_api.id(44760409832877189)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44761000424877189)
,p_plug_template_id=>wwv_flow_api.id(44760409832877189)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44761321381877189)
,p_plug_template_id=>wwv_flow_api.id(44760409832877189)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44761668662877189)
,p_plug_template_id=>wwv_flow_api.id(44760409832877189)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44761934178877189)
,p_plug_template_id=>wwv_flow_api.id(44760409832877189)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44762253443877189)
,p_plug_template_id=>wwv_flow_api.id(44760409832877189)
,p_name=>'Sub Regions'
