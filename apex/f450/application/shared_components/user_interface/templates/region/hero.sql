...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44764646516877190)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44764908196877190)
,p_plug_template_id=>wwv_flow_api.id(44764646516877190)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44765252588877190)
,p_plug_template_id=>wwv_flow_api.id(44764646516877190)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44765507463877190)
,p_plug_template_id=>wwv_flow_api.id(44764646516877190)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44765809709877190)
,p_plug_template_id=>wwv_flow_api.id(44764646516877190)
,p_name=>'Sub Regions'
