...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44782484569877199)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44782781063877199)
,p_plug_template_id=>wwv_flow_api.id(44782484569877199)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44783070884877199)
,p_plug_template_id=>wwv_flow_api.id(44782484569877199)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44783336775877199)
,p_plug_template_id=>wwv_flow_api.id(44782484569877199)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44783651797877199)
,p_plug_template_id=>wwv_flow_api.id(44782484569877199)
,p_name=>'Sub Regions'
