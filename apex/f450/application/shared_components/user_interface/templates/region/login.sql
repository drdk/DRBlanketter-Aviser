...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44784219520877200)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44784534325877200)
,p_plug_template_id=>wwv_flow_api.id(44784219520877200)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44784862705877200)
,p_plug_template_id=>wwv_flow_api.id(44784219520877200)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44785166080877200)
,p_plug_template_id=>wwv_flow_api.id(44784219520877200)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44785499869877200)
,p_plug_template_id=>wwv_flow_api.id(44784219520877200)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44785735265877200)
,p_plug_template_id=>wwv_flow_api.id(44784219520877200)
,p_name=>'Sub Regions'
