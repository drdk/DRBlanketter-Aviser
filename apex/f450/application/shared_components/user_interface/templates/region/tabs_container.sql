...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44796470732877204)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44796706206877204)
,p_plug_template_id=>wwv_flow_api.id(44796470732877204)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44797058153877205)
,p_plug_template_id=>wwv_flow_api.id(44796470732877204)
,p_name=>'Tabs'
